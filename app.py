...
except ImportError:  # Fallback for environments where top-level export is unavailable
...
market_options = {
    ...
    "Ireland": {
        ...
        "index": "^ISEQ",
        "stocks": ["CRH.IR", "RYA.IR", "GL9.IR", "DIDC.IR", "BKIR.IR"],
        "default_ticker": "CRH.IR",
    ...
    "Canada": {
        ...
        "timezone": "America/Toronto",
        "index": "^GSPTSE",
        "stocks": ["SHOP.TO", "RY.TO", "TD.TO", "ENB.TO", "BNS.TO"],
        "default_ticker": "RY.TO",
        "exchange": "TSX",
        "retirement_age": 65,
        "life_expectancy": 82,
    ...
    "Australia": {
        ...
        "timezone": "Australia/Sydney",
        "index": "^AXJO",
        "stocks": ["CBA.AX", "BHP.AX", "CSL.AX", "WBC.AX", "NAB.AX"],
        "default_ticker": "BHP.AX",
        "exchange": "ASX",
        "retirement_age": 67,
        "life_expectancy": 83,
    ...
    "Japan": {
        ...
        "timezone": "Asia/Tokyo",
        "index": "^N225",
        "stocks": ["7203.T", "6758.T", "9984.T", "9432.T", "7267.T"],
        "default_ticker": "7203.T",
        "exchange": "TSE",
        "retirement_age": 65,
        "life_expectancy": 85,
    ...
    "Germany": {
        ...
        "timezone": "Europe/Berlin",
        "index": "^GDAXI",
        "stocks": ["SAP.DE", "DTE.DE", "ALV.DE", "BMW.DE", "SIE.DE"],
        "default_ticker": "SAP.DE",
        "exchange": "XETRA",
        "retirement_age": 66,
        "life_expectancy": 81,
    ...
    "France": {
        ...
        "index": "^FCHI",
        "stocks": ["MC.PA", "OR.PA", "BNP.PA", "AIR.PA", "SAN.PA"],
    ...
    "Italy": {
        ...
        "index": "FTSEMIB.MI",
        "stocks": ["ENI.MI", "ENEL.MI", "ISP.MI", "UCG.MI", "STM.MI"],
    ...
    "Spain": {
        ...
        "index": "^IBEX",
        "stocks": ["SAN.MC", "IBE.MC", "ITX.MC", "BBVA.MC", "TEF.MC"],
    ...
    "Singapore": {
        ...
        "index": "^STI",
        "stocks": ["D05.SI", "O39.SI", "U11.SI", "C07.SI", "Z74.SI"],
    ...
    "Hong Kong": {
        ...
        "index": "^HSI",
        "stocks": ["0700.HK", "0939.HK", "1299.HK", "2318.HK", "0388.HK"],
    ...
    "Switzerland": {
        ...
        "index": "^SSMI",
        "stocks": ["NESN.SW", "NOVN.SW", "UBSG.SW", "ROG.SW", "ABBN.SW"],
    ...
    "Netherlands": {
        ...
        "timezone": "Europe/Amsterdam",
        "index": "^AEX",
        "stocks": ["ASML.AS", "SHELL.AS", "HEIA.AS", "AD.AS", "INGA.AS"],
        "default_ticker": "ASML.AS",
        "exchange": "Euronext Amsterdam",
        "retirement_age": 67,
        "life_expectancy": 82,
    ...
    "Belgium": {
        ...
        "index": "^BFX",
        "stocks": ["ABI.BR", "KBC.BR", "SOLB.BR", "UCB.BR", "ACKB.BR"],
        "default_ticker": "ABI.BR",
    ...
    "Portugal": {
        ...
        "index": "^PSI20",
        "stocks": ["EDP.LS", "GALP.LS", "BCP.LS", "JMT.LS", "EDPR.LS"],
        "default_ticker": "EDP.LS",
    ...
    "Denmark": {
        ...
        "index": "^OMXC25",
        "stocks": ["NOVO-B.CO", "ORSTED.CO", "VWS.CO", "DANSKE.CO", "CARL-B.CO"],
    ...
    "Norway": {
        ...
        "index": "^OSEAX",
        "stocks": ["EQNR.OL", "DNB.OL", "NHY.OL", "TEL.OL", "YAR.OL"],
    ...
    "Sweden": {
        ...
        "index": "^OMXS30",
        "stocks": ["VOLV-B.ST", "ERIC-B.ST", "HM-B.ST", "ATCO-A.ST", "SAND.ST"],
    ...
    "Finland": {
        ...
        "index": "^OMXH25",
        "stocks": ["NOKIA.HE", "FORTUM.HE", "NESTE.HE", "KNEBV.HE", "STERV.HE"],
    ...
    "Austria": {
        ...
        "index": "^ATX",
        "stocks": ["EBS.VI", "RBI.VI", "OMV.VI", "VER.VI", "ANDR.VI"],
        "default_ticker": "EBS.VI",
    ...
    "Mexico": {
        ...
        "index": "^MXX",
        "stocks": ["AMXL.MX", "FEMSAUBD.MX", "GFNORTEO.MX", "WALMEX.MX", "BBAJIOO.MX"],
        "default_ticker": "AMXL.MX",
        "exchange": "BMV",
        "retirement_age": 65,
        "life_expectancy": 76,
        "inflation_rate": 0.045,
...
with st.sidebar:
    ...
    # Set selected_market from session state
    ...
    for market in filtered_markets:
        ...
        # Get correct currency symbol for this market
        market_currency_code = info.get("currency", "USD")
        market_currency_symbol = get_currency_symbol(market_currency_code)
        ...
        st.markdown(f"""
            <div class="market-card {selected_class} {trading_class}">
                ...
                <div class="market-info">
                    <span>💱 {market_currency_symbol}</span>
                    <span>📈 {exchange}</span>
                </div>
...
@st.cache_data(ttl=1800)
def fetch_google_news_rss(query_term, site_domain=None, max_items=6, hl="en-US", gl="US", ceid="US:en"):
    news_items, error_message = [], None
    try:
        query = quote_plus(query_term + (f" site:{site_domain}" if site_domain else ""))
        feed_url = f"https://news.google.com/rss/search?q={query}&hl={hl}&gl={gl}&ceid={ceid}"
        feed = feedparser.parse(feed_url)
        if getattr(feed, 'bozo', 0):
            return [], f"RSS parse error for {site_domain or 'global'}"
        for entry in feed.entries[:max_items]:
            title = entry.get('title', '')
            link = entry.get('link', '')
            published = entry.get('published', '') or entry.get('updated', '')
            source_title = (entry.get('source', {}) or {}).get('title') if isinstance(entry.get('source', {}), dict) else entry.get('source', None)
            news_items.append({
                'title': title,
                'link': link,
                'publisher': source_title or (site_domain or 'Google News RSS'),
                'source': f"Google News RSS{f' ({site_domain})' if site_domain else ''}",
                'published': published,
                'image_url': None
            })
        if not news_items:
            error_message = f"No items for {site_domain or 'global'}"
    except Exception as e:
        error_message = f"RSS error for {site_domain or 'global'}: {str(e)}"
    return news_items, error_message

@st.cache_data(ttl=1800)
def get_curated_publisher_news(company_name):
    domains = [
        'bloomberg.com',
        'cnbc.com',
        'marketwatch.com',
    ...
    for domain in domains:
        items, err = fetch_google_news_rss(company_name + " stock", site_domain=domain, max_items=4)
        if items:
    ...
    for item in combined:
        ...
        seen.add(url)
        deduped.append(item)
    return deduped[:12], ("; ".join(errors) if errors else None)
...
if ticker:
    ...
    with st.spinner(f"Summoning insights for {ticker}... This might take a moment."):
        ...
        # Aggregate from all sources instead of short-circuiting
        if NEWS_API_KEY:
        ...
        curated_items, curated_err = get_curated_publisher_news(company_name_for_news_search)
        # Global Google News RSS for broader fallback (company name and ticker)
        rss_global_by_name, _ = fetch_google_news_rss(company_name_for_news_search + " stock", site_domain=None, max_items=8)
        rss_global_by_ticker, _ = fetch_google_news_rss(ticker + " stock", site_domain=None, max_items=6)
        # India-focused RSS (useful for NSE/BSE tickers)
        rss_india_by_name, _ = fetch_google_news_rss(company_name_for_news_search + " stock", site_domain=None, max_items=8, hl="en-IN", gl="IN", ceid="IN:en")
        rss_india_by_ticker, _ = fetch_google_news_rss(ticker + " stock", site_domain=None, max_items=6, hl="en-IN", gl="IN", ceid="IN:en")

        aggregated_candidates = []
        for bucket in [news_items_api or [], scraped_gnews_items or [], scraped_yfinance_items or [], curated_items or [], rss_global_by_name or [], rss_global_by_ticker or [], rss_india_by_name or [], rss_india_by_ticker or []]:
            aggregated_candidates.extend(bucket)
        # Deduplicate by link/url
        seen_links = set()
        for item in aggregated_candidates:
            link_val = item.get('link') or item.get('url')
            if not link_val or link_val in seen_links:
                continue
            seen_links.add(link_val)
            processed_news_for_sentiment.append(item)
        # Cap total to reasonable number
        processed_news_for_sentiment = processed_news_for_sentiment[:20]
    ...
    with tabs[2]: 
        ...
        # Build tabs including an All Sources view as fallback
        news_by_source = {
            'NewsAPI': news_items_api,
            'Google News': scraped_gnews_items,
            'Yahoo Finance': scraped_yfinance_items,
            'All Sources': processed_news_for_sentiment
        }
    ...
    with tabs[5]:
        st.markdown("""
            <div style="text-align: center; margin-bottom: 2rem;">
                <h1 style="
                    ...
                    margin-bottom: 0.5rem;
                ">🧠 AI Crystal Ball</h1>
                <p style="color: #888; font-size: 1.2em;">Advanced AI Analysis & Future Predictions</p>
            </div>
        """, unsafe_allow_html=True)
        
        # Create tabs for different analysis sections
        ai_tabs = st.tabs(["🔮 Future Predictions", "📊 Risk Analysis", "📰 News Sentiment", "🎯 AI Insights"])
        
        # --- Future Predictions Tab ---
        with ai_tabs[0]:
            st.markdown("""
                <div class="animated-card">
                    <h3 class="glow-text">🔮 AI-Powered Future Predictions</h3>
                    <p>Advanced analysis based on historical data, technical indicators, and market sentiment</p>
                </div>
            """, unsafe_allow_html=True)
            
            # Calculate predictions based on historical data and trends
            if not df.empty and current_price:
                # Get historical performance for prediction basis
                hist_returns = df['Close'].pct_change().dropna()
                avg_return = hist_returns.mean() * 252  # Annualized
                volatility = hist_returns.std() * np.sqrt(252)
                
                # Calculate prediction periods
                periods = {
                    "3 Months": 0.25,
                    "6 Months": 0.5,
                    "1 Year": 1.0,
                ...
                for i, (period_name, years) in enumerate(periods.items()):
                    with pred_cols[i]:
                        # Calculate expected price range
                        expected_return = avg_return * years
                        price_change = current_price * expected_return
                        predicted_price = current_price + price_change
                        
                        # Add volatility bands
                        volatility_impact = current_price * volatility * np.sqrt(years)
                        upper_bound = predicted_price + volatility_impact
                        lower_bound = predicted_price - volatility_impact
                        ...
                        st.markdown(f"""
                            <div style="
                                ...
                                margin: 10px 0;
                            ">
                                <h4 style="color: {conf_color};">{period_name}</h4>
                                <h3 style="color: #fff; margin: 10px 0;">{current_currency_symbol}{predicted_price:.2f}</h3>
                                <p style="color: #888; font-size: 0.9em;">
                                    Range: {current_currency_symbol}{lower_bound:.2f} - {current_currency_symbol}{upper_bound:.2f}
                                </p>
                                <div style="
                ...
                # Prediction Summary
                st.markdown("---")
                st.markdown("#### 📈 Prediction Analysis Summary")
                ...
                fig_pred.add_trace(go.Scatter(
                    x=['Current'] + list(predictions.keys()),
                    y=[current_price] + [pred['price'] for pred in predictions.values()],
                    mode='lines+markers',
                ...
                for period, pred in predictions.items():
                    fig_pred.add_trace(go.Scatter(
                        x=[period, period],
                        y=[pred['lower'], pred['upper']],
                        mode='lines',
                        line=dict(color=pred['color'], width=2, dash='dash'),
                        showlegend=False
                    ))
                
                fig_pred.update_layout(
                    title="Price Prediction Timeline",
                    template='plotly_dark',
                    plot_bgcolor='#0e0e0e',
                    paper_bgcolor='#0e0e0e',
                    height=400,
                    yaxis_title=f"Price ({current_currency_symbol})",
                ...
                if avg_return > 0.1:
                    trend_insight = "Strong upward trend detected"
                    trend_color = "#39ff14"
                elif avg_return > 0.05:
                    trend_insight = "Moderate growth potential"
                    trend_color = "#FFD700"
                else:
                    trend_insight = "Limited growth expected"
                    trend_color = "#FF4444"
                
                if volatility < 0.2:
                    risk_insight = "Low volatility - stable investment"
                    risk_color = "#39ff14"
                elif volatility < 0.4:
                    risk_insight = "Moderate risk - balanced potential"
                    risk_color = "#FFD700"
                else:
                    risk_insight = "High volatility - high risk/reward"
                    risk_color = "#FF4444"
                ...
                with insight_cols[0]:
                    st.markdown(f"""
                        <div style="
                            ...
                            margin: 10px 0;
                        ">
                            <h5 style="color: {trend_color};">📈 Trend Analysis</h5>
                            <p style="color: #e0e0e0;">{trend_insight}</p>
                            <p style="color: #888;">Annual Return: {avg_return:.1%}</p>
                        </div>
                    """, unsafe_allow_html=True)
                ...
                with insight_cols[1]:
                    st.markdown(f"""
                        <div style="
                            ...
                            margin: 10px 0;
                        ">
                            <h5 style="color: {risk_color};">⚠️ Risk Assessment</h5>
                            <p style="color: #e0e0e0;">{risk_insight}</p>
                            <p style="color: #888;">Volatility: {volatility:.1%}</p>
                        </div>
                    """, unsafe_allow_html=True)
        ...
        with ai_tabs[1]:
            st.markdown("""
                <div class="animated-card">
                    <h3 class="glow-text">📊 Comprehensive Risk Analysis</h3>
                    <p>Multi-dimensional risk assessment using advanced metrics</p>
                </div>
            """, unsafe_allow_html=True)
            ...
            if volatility_percent is not None and risk_level:
                ...
                with risk_metrics_cols[0]:
                    st.metric("Volatility", f"{volatility_percent:.1f}%", 
                             delta=f"{volatility_percent - 20:.1f}%" if volatility_percent > 20 else f"{volatility_percent - 20:.1f}%")
                
                with risk_metrics_cols[1]:
                    # Calculate Beta if market data available
                    try:
                        market_data = fetch_stock_data(market_index, period="1y")
                        if not market_data.empty and not df.empty:
                            stock_returns = df['Close'].pct_change().dropna()
                            market_returns = market_data['Close'].pct_change().dropna()
                            # Align dates
                            common_dates = stock_returns.index.intersection(market_returns.index)
                            if len(common_dates) > 30:
                                beta = np.cov(stock_returns[common_dates], market_returns[common_dates])[0,1] / np.var(market_returns[common_dates])
                                st.metric("Beta", f"{beta:.2f}", 
                                         delta=f"{beta - 1:.2f}" if beta > 1 else f"{beta - 1:.2f}")
                            else:
                                st.metric("Beta", "N/A")
                        else:
                            st.metric("Beta", "N/A")
                ...
                st.markdown(f"""
                    <div style="
                        ...
                        text-align: center;
                    ">
                        <h2 style="color: {risk_color}; margin-bottom: 10px;">Risk Level: {risk_level}</h2>
                        <p style="color: #e0e0e0; font-size: 1.1em;">{risk_explanation_text}</p>
                    </div>
                """, unsafe_allow_html=True)
                ...
                if volatility_percent > 30:
                    risk_factors.append(("High Volatility", "Stock shows significant price swings", "#FF4444"))
                if volatility_percent < 10:
                    risk_factors.append(("Low Volatility", "Stock shows stable price movement", "#39ff14"))
                
                # Add more risk factors based on available data
                if s_info_full:
                    if s_info_full.get('debtToEquity', 0) > 1:
                        risk_factors.append(("High Debt", "Company has significant debt levels", "#FFA500"))
                    if s_info_full.get('currentRatio', 0) < 1:
                        risk_factors.append(("Liquidity Risk", "Low current ratio indicates liquidity concerns", "#FF4444"))
                ...
                for factor, description, color in risk_factors:
                    st.markdown(f"""
                        <div style="
                            ...
                            margin: 10px 0;
                        ">
                            <h5 style="color: {color};">{factor}</h5>
        ...
        with ai_tabs[2]:
            st.markdown("""
                <div class="animated-card">
                    <h3 class="glow-text">📰 Advanced News Sentiment Analysis</h3>
                    <p>Real-time sentiment tracking and impact analysis</p>
                </div>
            """, unsafe_allow_html=True)
            
            if processed_news_for_sentiment:
                # Overall Sentiment Summary
                overall_sentiment = overall_news_sentiment_stats
                
                sent_cols = st.columns(4)
                with sent_cols[0]:
                    st.metric("Overall Sentiment", overall_sentiment.get('label', 'Neutral'))
                with sent_cols[1]:
                    st.metric("Sentiment Score", f"{overall_sentiment.get('score', 0):.3f}")
                with sent_cols[2]:
                    st.metric("Positive News", overall_sentiment.get('positive_count', 0))
                with sent_cols[3]:
                    st.metric("Negative News", overall_sentiment.get('negative_count', 0))
                ...
                # Recent News with Enhanced Sentiment
                st.markdown("#### 📰 Latest News & Sentiment Impact")
                for news_item in processed_news_for_sentiment[:8]:
                    sentiment = news_item.get('vader_sentiment', {})
                    sentiment_score = sentiment.get('compound', 0)
                    
                    # Determine sentiment color and impact
                    ...
                    st.markdown(f"""
                        ...
                        ">
                            ...
                            <p style="color: #e0e0e0; font-size: 0.9em;">{news_item.get('description', news_item.get('text', 'No content available'))[:200]}...</p>
                            <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                                <span style="color: #888;">{news_item.get('publisher', 'Unknown Source')}</span>
                                <span style="color: {sent_color}; font-weight: bold;">{impact} ({sentiment_score:.2f})</span>
                            </div>
                        </div>
                    """, unsafe_allow_html=True)
            else:
        ...
        with ai_tabs[3]:
            st.markdown("""
                <div class="animated-card">
                    <h3 class="glow-text">🎯 AI Investment Insights</h3>
                    <p>Comprehensive AI analysis and investment recommendations</p>
                </div>
            """, unsafe_allow_html=True)
            
            # AI Recommendation
            if signal and signal_reason:
                signal_color = '#39ff14' if signal == 'BUY' else '#FF4444' if signal == 'SELL' else '#FFD700'
                ...
                st.markdown(f"""
                    <div style="
                        ...
                        text-align: center;
                    ">
                        <h2 style="color: {signal_color}; margin-bottom: 10px;">AI Signal: {signal}</h2>
                        <p style="color: #e0e0e0; font-size: 1.1em;">{signal_reason}</p>
                    </div>
                """, unsafe_allow_html=True)
            ...
            if avg_return and volatility:
                if avg_return > 0.15 and volatility < 0.3:
                    strategy_insights.append(("High Growth, Low Risk", "Excellent investment opportunity with strong growth potential and manageable risk", "#39ff14"))
                elif avg_return > 0.1:
                    strategy_insights.append(("Growth Focus", "Good growth potential, consider for growth portfolio", "#90EE90"))
                elif volatility < 0.2:
                    strategy_insights.append(("Stable Investment", "Low volatility makes it suitable for conservative investors", "#39ff14"))
                else:
                    strategy_insights.append(("High Risk/Reward", "High volatility suggests potential for significant gains or losses", "#FFD700"))
            
            if s_info_full:
                if s_info_full.get('dividendYield', 0) > 0.03:
                    strategy_insights.append(("Dividend Play", "Attractive dividend yield for income investors", "#87CEEB"))
                if s_info_full.get('marketCap', 0) > 1e10:  # Large cap
                    strategy_insights.append(("Large Cap Stability", "Large market cap provides stability and lower volatility", "#39ff14"))
            
            for strategy, description, color in strategy_insights:
                st.markdown(f"""
                    <div style="
                        padding: 15px;
                        border-radius: 10px;
                        ...
                        margin: 10px 0;
                    ">
                        <h5 style="color: {color};">{strategy}</h5>
                        <p style="color: #e0e0e0;">{description}</p>
                    </div>
                """, unsafe_allow_html=True)
            ...
            if s_info_full:
                ...
                with market_metrics[0]:
                    st.metric("Market Cap", f"{current_currency_symbol}{s_info_full.get('marketCap', 0)/1e9:.1f}B" if s_info_full.get('marketCap') else "N/A")
                
                with market_metrics[1]:
                    st.metric("P/E Ratio", f"{s_info_full.get('trailingPE', 0):.1f}" if s_info_full.get('trailingPE') else "N/A")
                
                with market_metrics[2]:
                    st.metric("52W Range", f"{current_currency_symbol}{s_info_full.get('fiftyTwoWeekLow', 0):.2f} - {current_currency_symbol}{s_info_full.get('fiftyTwoWeekHigh', 0):.2f}" if s_info_full.get('fiftyTwoWeekLow') and s_info_full.get('fiftyTwoWeekHigh') else "N/A")
    ...
    with tabs[9]:  # Index 9 for About StockSeer.AI
        # Resolve app logo source with a safe fallback if local asset is missing
        app_logo_src = APP_LOGO_MAIN_PATH
        try:
            if not os.path.exists(app_logo_src):
                app_logo_src = "https://dummyimage.com/70x70/39ff14/0a0a0a.png&text=SS"
        except Exception:
            app_logo_src = "https://dummyimage.com/70x70/39ff14/0a0a0a.png&text=SS"
        ...
        st.markdown("""
            ...
            <div class="about-hero-bg">
                <div class="about-hero-logo">
                    <img src="{app_logo_src}" alt="StockSeer.AI Logo" style="width: 70px; height: 70px; border-radius: 16px;"/>
                </div>
                <div style="text-align:center; margin-top: 0.4rem;">
                    <a href="https://www.flaticon.com/free-icons/stock" title="stock icons" target="_blank" rel="noopener" style="color:#8aa08d; font-size: 0.85rem; text-decoration: underline;">
                        Stock icons created by ultimatearm - Flaticon
                    </a>
                </div>
            ...
            <div class="about-cta">
                Ready to join the future of investing? <a href="mailto:hello@stockseer.ai" style="color:#0a0a0a; text-decoration:underline; font-weight:700;">Contact Us</a> or Connect on LinkedIn:
                <a href="https://www.linkedin.com/in/ranvijay-singh-58182a325?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener" style="color:#0a0a0a; text-decoration:underline; font-weight:700;">Founder & CEO</a>
                ·
                <a href="http://www.linkedin.com/in/raghav-agrawal-4431932ab" target="_blank" rel="noopener" style="color:#0a0a0a; text-decoration:underline; font-weight:700;">CTO</a>
                ·
                <a href="https://www.linkedin.com/in/ravi-gupta-2273a2297?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener" style="color:#0a0a0a; text-decoration:underline; font-weight:700;">CPO</a>
            </div>
        """, unsafe_allow_html=True)
